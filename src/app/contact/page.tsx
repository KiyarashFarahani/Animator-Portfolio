  ...
  return (
    <main className="min-h-screen text-white">
      <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-32 lg:px-16">
        <div className="pointer-events-none absolute -top-32 right-0 h-[480px] w-[480px] rounded-full bg-white/[0.04] blur-[120px]" />
        <div className="pointer-events-none absolute top-40 -left-32 h-[360px] w-[360px] rounded-full bg-white/[0.03] blur-[100px]" />
        ...
        <div className="relative">
          ...
          <div className="mt-14 grid gap-5 md:grid-cols-2">
            <a
              ...
              className="group relative overflow-hidden rounded-[28px] bg-white/[0.04] p-8 ring-1 ring-white/10 backdrop-blur transition hover:bg-white/[0.07] hover:ring-white/15"
            >
              <div className="absolute -right-8 -top-8 h-32 w-32 rounded-full bg-white/[0.06] blur-2xl transition group-hover:bg-white/[0.09]" />
              <div className="relative">
